...
var state = {
    ...
    "current_buy_in":400,                          // The amount of the largest current bet from any one player
    ...
    "players": [                                    // An array of the players. The order stays the same during the
        {                                           //     entire tournament
            ...
            "bet": 400                              // The amount of chips the player put into the pot
        },
        {
...
t.bet_request(state, function(a){console.log(a)});
